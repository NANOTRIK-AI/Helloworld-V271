...
contract V271Token is ERC20, ERC20Burnable, Pausable, AccessControl {
    ...
    // Mathematical constants (fixed-point representation with 18 decimals)
    uint256 public constant APERY_CONSTANT = 1202056903159594285; // ζ(3) * 10^18
    ...
    uint256 private constant INITIAL_SUPPLY = 271000000 * 10**18; // 271 million tokens
    uint256 private constant MAX_SUPPLY = 271000000 * 1202056903 / 1000000000 * 10**18; // Max supply derived from Apery's constant
    ...
    // Meta-transaction related variables
